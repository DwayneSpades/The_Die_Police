...
public class dante : gamblerInterface
{
    ...
    public override bool chargeRoll()
    {
        if (!chargingRoll)
        {
            gambler_anim.Play("dante_charge");
    ...
    {
        gambler_anim.Play("dante_swipedDice");
    }

    public override void missedSwipe()
    {
        gambler_anim.Play("dante_missedSwipe");
    }
    public override void angered()
    {
        gambler_anim.Play("dante_angered");
    }
